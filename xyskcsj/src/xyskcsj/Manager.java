...
public class Manager extends JFrame implements TreeSelectionListener {
	...
	public Manager() {
		...
		t1 = new DefaultMutableTreeNode("基本信息管理");
		t1_1 = new DefaultMutableTreeNode("查询员工");
		t1_2 = new DefaultMutableTreeNode("添加员工");
		t1_3 = new DefaultMutableTreeNode("修改员工信息");
		t1_4 = new DefaultMutableTreeNode("删除员工资料");
		t1_5 = new DefaultMutableTreeNode("查询全体员工");

		t2 = new DefaultMutableTreeNode("人员考核管理");
		t2_1 = new DefaultMutableTreeNode("人员考核");
		t2_2 = new DefaultMutableTreeNode("考核历史查询");
